...
/// @DnDVersion : 1
/// @DnDHash : 51E0EDB1
/// @DnDArgument : "code" "/// @description vertical collision$(13_10)$(13_10)if place_meeting(x,y+spd, o_room1_collider) {$(13_10)	audio_play_sound(s_explosion_of_big_bubble,10,false);$(13_10)	instance_destroy();$(13_10)}$(13_10)"
/// @description vertical collision

if place_meeting(x,y+spd, o_room1_collider) {
	audio_play_sound(s_explosion_of_big_bubble,10,false);
	instance_destroy();
}