...
/// @DnDVersion : 1
/// @DnDHash : 22B203B8
/// @DnDArgument : "code" "/// @description horizontal collision$(13_10)$(13_10)if place_meeting(x+hsp, y, o_ground) {$(13_10)	while (!place_meeting(x+sign(hsp),y,  o_ground)) {$(13_10)		x = x + sign(hsp);$(13_10)	}$(13_10)	hsp = 0;$(13_10)} else if place_meeting(x+hsp, y, o_room1_collider) {$(13_10)	while (!place_meeting(x+sign(hsp),y,  o_room1_collider)) {$(13_10)		x = x + sign(hsp);$(13_10)	}$(13_10)	hsp = 0;$(13_10)}$(13_10)$(13_10)x = x + hsp;"
...
if place_meeting(x+hsp, y, o_ground) {
	...
	hsp = 0;
} else if place_meeting(x+hsp, y, o_room1_collider) {
...
else if place_meeting(x,y+vsp, o_room1_collider) {
